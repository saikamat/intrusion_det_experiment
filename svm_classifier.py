...
category_names = [' Destination Port', ' Flow Duration', ' Total Fwd Packets', ' Total Backward Packets', 'Total Length of Fwd Packets', ' Total Length of Bwd Packets', ' Fwd Packet Length Max', \
...
example_filename = os_join(dataroot,filenames[0])
category_names = read_csv_header(example_filename)

data = read_csv(example_filename)
